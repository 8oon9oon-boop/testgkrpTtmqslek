			...
			<table class="member-form theme-form">
				...
				<tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="file" name="mb_icon" id="reg_mb_icon" class="frm_input" accept="image/*">
                            <?php if ($w == 'u' && file_exists($mb_icon_path)) { ?>
                            <div style="margin-top:5px;">
                                <img src="<?php echo $mb_icon_url ?>" alt="프로필 이미지" style="vertical-align:middle; border:1px solid #ccc; max-width:50px;">
                                <label style="margin-left:10px; cursor:pointer;"><input type="checkbox" name="del_mb_icon" value="1"> 삭제</label>
                            </div>
                            <?php } ?>
                            <span class="frm_info" style="display:block; margin-top:5px; font-size:12px; color:#888;">
                                이미지 크기는 가로 <strong><?php echo $config['cf_member_icon_width'] ?>px</strong>, 세로 <strong><?php echo $config['cf_member_icon_height'] ?>px</strong> 이하, 용량은 <strong><?php echo number_format($config['cf_member_icon_size']) ?>바이트</strong> 이하로 업로드 해주세요. (gif, jpg, png 가능)
                            </span>
                        </td>
                    </tr>
                    </tbody>
